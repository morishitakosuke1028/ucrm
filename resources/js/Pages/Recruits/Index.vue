                                    ...
                                    <table id="sort_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="px-4 py-3 title-font font-medium text-gray-900 text-sm bg-gray-100">メールアドレス▼</th>
                                        ...
                                        <tbody>
                                            <tr v-for="recruit in recruits" :key="recruit.id">
                                                ...
                                                <td class="px-4 py-3">{{ dayjs(recruit.created_at).format('YYYY-MM-DD HH:mm:ss') }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
