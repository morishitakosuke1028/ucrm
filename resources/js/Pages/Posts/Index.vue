                            ...
                            <div class="container px-5 py-24 mx-auto">
                                ...
                                <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                                    <table id="sort_table">
                                        <thead>
                                            <tr>
                                                <th class="px-4 py-3 title-font font-medium text-gray-900 text-sm bg-gray-100">ID▼</th>
                                                <th class="px-4 py-3 title-font font-medium text-gray-900 text-sm bg-gray-100">タイトル▼</th>
                                                <th class="px-4 py-3 title-font font-medium text-gray-900 text-sm bg-gray-100">内容▼</th>
                                                <th class="px-4 py-3 title-font font-medium text-gray-900 text-sm bg-gray-100">投稿日▼</th>
                                            </tr>
                                        </thead>
